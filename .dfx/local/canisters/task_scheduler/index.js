...
import { idlFactory } from './task_scheduler.did.js';
export { idlFactory } from './task_scheduler.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_TASK_SCHEDULER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./task_scheduler.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the task_scheduler canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./task_scheduler.did.js")._SERVICE>}
 */
export const task_scheduler = createActor(canisterId);
